<div class="pick_flat">
	<div class="width_960">
		...
		<div class="no_time">
			<p class="no_time_head">Нет времени на поиск дома,<br/> дачи, коттеджа самостоятельно?</p>
...
<div class="cooperate">
	<div class="width_960">
		...
		<div class="row">
			<p class="item-1">Наша база данных содержит свыше 1000 объектов на рынке загородной недвижимости</p>
			<p class="item-2">Мы работаем с сертификатами по любой программе: молодая семья, материнский капитал и т.д.</p>
		</div>
		<div class="row">
			<p class="item-3">Огромный выбор загородной недвижимости, услуги по межеванию и определению границ участка, постановка на кадастровый учет.</p>
...
<div class="how_pick">
	...
	<div class="width_960 pick">
		<h3>Как мы будем подбирать</h3><h2>вам недвижимость</h2>
		...
		<p class="step3">Мы делаем подборку объектов по вашим параметрам</p>
